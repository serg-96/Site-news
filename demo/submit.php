...
/*Данный массив будет наполняться либо данными,которые передаются в скрипт,
...
/*Данные в $arr подготовлены для запроса mysql,но нам нужно делать вывод на экран, поэтому
